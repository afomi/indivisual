defmodule IndivisualWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(IndivisualWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(IndivisualWeb.Gettext, "errors", msg, opts)
    end
  end
