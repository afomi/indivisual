...
- **Always** manually write your own tailwind-based components for a unique, world-class design. There is no component library in this project (daisyUI was removed); do not add one
